  ...
  <div class="h-full flex flex-col">
    ...
    <div class="flex-1 overflow-y-auto">
      <div class="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8">
        ...
        <div class="space-y-6">
          <!-- Overview card -->
          <div class="bg-bg-tertiary border border-border-primary rounded-xl p-8">
...
const loadFeatureData = () => {
  ...
  const features = storage.getFeatures(props.projectId)
  feature.value = features.find(f => f.id === props.featureId)
  ...
  // Update context when feature is loaded
  emit('update-context', {
    type: 'feature',
    item: feature.value
  })
...
const updateStatus = (newStatus) => {
  ...
  storage.saveFeature(props.projectId, feature.value)
